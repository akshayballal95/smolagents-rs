...
pub fn user_prompt_plan(
    ...
    managed_agent_descriptions: &str,
    answer_facts: &str,
) -> String {
    format!(
        "Here is your task:
...
Now begin! Write your plan below",
        task, tool_descriptions, managed_agent_descriptions, answer_facts
    )
}
...
pub const FUNCTION_CALLING_SYSTEM_PROMPT: &str = r#"You are an expert assistant who can solve any task
{{managed_agents_descriptions}}
